...
GO
PRINT N'Rename refactoring operation with key 552f97fa-c033-4095-897a-dcd6f574fd3b is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 68ce7ebf-1a4d-49ee-a51d-5401f1139af6 is skipped, element [dbo].[Fato_001].[Quantidade_Vendia] (SqlSimpleColumn) will not be renamed to Quantidade_Vendida';


GO
PRINT N'Rename refactoring operation with key de35301c-96ef-4d7a-90c8-15267e66cd5b is skipped, element [dbo].[FK_Fato_001_ToTable] (SqlForeignKeyConstraint) will not be renamed to [FK_Fato_001_Dim_Cliente]';


GO
PRINT N'Rename refactoring operation with key 88ed63e6-22f2-43b1-896d-d7593562f8f5 is skipped, element [dbo].[Fato_003].[Frete] (SqlSimpleColumn) will not be renamed to Custo_Fixo';

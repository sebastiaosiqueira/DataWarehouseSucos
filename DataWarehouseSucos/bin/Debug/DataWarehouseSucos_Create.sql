...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b5f82f17-753c-41ba-838c-948fe79a1d68')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b5f82f17-753c-41ba-838c-948fe79a1d68')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8d961ed4-dd7f-4871-91c5-b76d22ce82b0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8d961ed4-dd7f-4871-91c5-b76d22ce82b0')
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '552f97fa-c033-4095-897a-dcd6f574fd3b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('552f97fa-c033-4095-897a-dcd6f574fd3b')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '68ce7ebf-1a4d-49ee-a51d-5401f1139af6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('68ce7ebf-1a4d-49ee-a51d-5401f1139af6')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'de35301c-96ef-4d7a-90c8-15267e66cd5b')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('de35301c-96ef-4d7a-90c8-15267e66cd5b')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '88ed63e6-22f2-43b1-896d-d7593562f8f5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('88ed63e6-22f2-43b1-896d-d7593562f8f5')
